...
**Files:**
- [flaskapp.py](flaskapp.py) — main Flask application and routes
- [database_create.py](database_create.py) — creates the database schema
- [database_add.py](database_add.py) — adds the admin info
- `templates/` — HTML templates (register, login, admin dashboard, details)
- `static/` — CSS file
